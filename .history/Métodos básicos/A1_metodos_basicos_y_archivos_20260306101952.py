...
Para una presentación (sin pedir datos), ejecuta:
    python A1_metodos_basicos_y_archivos.py --presentacion
"""
...
def parte_1_metodos_basicos(presentacion: bool = False) -> None:
    ...
    if presentacion:
        ...
        numero1_texto = "10"
        numero2_texto = "5"
        print("¿Cómo te llamas? Ana")
        print("¡Hola,", nombre_usuario, "!")
        print("Escribe un número: 10")
        print("Escribe otro número: 5")
    else:
