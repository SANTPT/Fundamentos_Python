...
CÓMO PRESENTAR:
  En la terminal, desde la carpeta del proyecto:
    python3 "Métodos básicos/A1_metodos_basicos_y_archivos.py" --presentacion
  Así se ejecuta todo sin pedirte datos (ideal para una demo).
"""
...
def parte_1_metodos_basicos(presentacion: bool = False) -> None:
    ...
    if presentacion:
        ...
        numero1_texto = "10"
        numero2_texto = "5"
        print("¿Cómo te llamas?", nombre_usuario)
        print("¡Hola,", nombre_usuario, "!")
        print("Escribe un número:", numero1_texto)
        print("Escribe otro número:", numero2_texto)
    else:
...
def main() -> None:
    ...
    parte_1_metodos_basicos(presentacion=presentacion)
    parte_2_archivos()
